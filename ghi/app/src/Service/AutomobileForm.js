      ...
      <form onSubmit={handleSubmit} id="create-automobile-form">
        <div className="form-floating mb-3">
          <input
            ...
            onChange={(e) =>
              setAutomobile({ ...automobile, color: e.target.value })
            }
            placeholder="Automobile_color"
            required
            type="text"
            name="automobile_color"
            id="automobile_color"
        ...
        <div className="form-floating mb-3">
          <input
            ...
            onChange={(e) =>
              setAutomobile({ ...automobile, year: e.target.value })
            }
            placeholder="Automobile_year"
            required
            type="text"
            name="automobile_year"
            id="automobile_year"
            className="form-control"
          />
        ...
        <div className="form-floating mb-3">
          <input
            ...
            onChange={(e) =>
              setAutomobile({ ...automobile, vin: e.target.value })
            }
            placeholder="Automobile_vin"
            required
            type="text"
            name="automobile_vin"
            id="automobile_vin"
        ...
        <div className="mb-3">
          <select
            ...
            onChange={(e) =>
              setAutomobile({ ...automobile, model_id: e.target.value })
            }
